...
CREATE TABLE `personel` (
  `personel_tc` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
  `personel_adi` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `personel_soyadi` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`personel_tc`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of personel
-- ----------------------------
INSERT INTO `personel` VALUES ('15412853198', 'Ayşe ', 'Yağmur');
INSERT INTO `personel` VALUES ('24532567841', 'Ömer', 'Çetin');
INSERT INTO `personel` VALUES ('54175234265', 'Hasan', 'Karaköse');
...
CREATE TABLE `salon` (
  ...
  CONSTRAINT `seans_id_for` FOREIGN KEY (`seans_id`) REFERENCES `seans` (`seans_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of salon
-- ----------------------------
INSERT INTO `salon` VALUES ('1', 'Salon 1', '3', '4');
INSERT INTO `salon` VALUES ('2', 'Salon 2', '2', '2');
INSERT INTO `salon` VALUES ('3', 'Salon 3', '3', '3');
